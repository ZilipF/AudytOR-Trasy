  ...
  function evaluateSchedule(orderedIdx, durMatrix, auditMin, days){
    ...
    function inspectSplit(cuts){
      ...
      for(var day = 0; day < days; day++){
        ...
        // Stacji starcza na każdy dzień, a ten podział i tak zostawia
        // któryś pusty — odrzucamy. Bez tego "trasa 3-dniowa" mogła upychać
        // wszystko w 2 dni, bo nic jej w tym nie powstrzymywało (patrz niżej,
        // stara wersja tej funkcji wręcz to premiowała). Gdy stacji jest
        // mniej niż dni, pusty dzień jest nieunikniony i to jest w porządku.
        if(end === start && stationCount >= days){ return; }
